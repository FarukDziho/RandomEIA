# ============================================================
# EIA860_Solar.ps1 - Load Schedule 3.3 Solar Data  v2.3
...
if (-not $solarFile) { Write-Warning "Solar file not found - skipping"; Write-EIALog -conn $conn -logId $logId -status "Skipped" -reportYear $ReportYear -errorMessage "Solar file not found" -startTime $startTime; $conn.Close(); exit 0 }

# ============================================================
# EIA860_Shared.ps1
# Version 2.3 - Bulletproof null handling
# ============================================================
...
# ============================================================
# BULLETPROOF Get-Val - handles all null scenarios
# ============================================================
function Get-Val {
    param($row, [string]$colName)
    # Return empty string for any failure
    if ($null -eq $row)     { return "" }
    if ($null -eq $colName) { return "" }
    if ($colName -eq "")    { return "" }
    try {
        # Use hashtable-style access which is safest with ImportExcel objects
        $val = $row.$colName
...
# ============================================================
# Check if a row is empty/header row
# ============================================================

# ============================================================
# EIA860_Wind.ps1 - Load Schedule 3.2 Wind Data  v2.3
...
if (-not $windFile) { Write-Warning "Wind file not found - skipping"; Write-EIALog -conn $conn -logId $logId -status "Skipped" -reportYear $ReportYear -errorMessage "Wind file not found" -startTime $startTime; $conn.Close(); exit 0 }

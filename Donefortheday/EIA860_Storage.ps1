# ============================================================
# EIA860_Storage.ps1 - Load Schedule 3.4 Energy Storage  v2.3
...
if (-not $storageFile) { Write-Warning "Storage file not found - skipping"; Write-EIALog -conn $conn -logId $logId -status "Skipped" -reportYear $ReportYear -errorMessage "Storage file not found" -startTime $startTime; $conn.Close(); exit 0 }
